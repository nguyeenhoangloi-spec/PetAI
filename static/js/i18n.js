...
(function () {
  ...
  "vi": {
    ...
    "approveBankTransfersDesc": "Hiển thị các đơn người dùng đã báo chuyển khoản để admin duyệt nâng cấp gói.",
    ...
    "analyzeNowBtn": "Nhận diện ngay",
    "quotaPlanPrefix": "Gói: ",
    "watchAdToUnlock": "Xem quảng cáo để thêm lượt",
    "validImageBadge": "Ảnh hợp lệ",
    "invalidImageBadge": "Ảnh không hợp lệ",
    "deleteImageBtn": "Xóa",
    "securityNote": "Dữ liệu của bạn được bảo mật tuyệt đối",
    "processingTitle": "Quy trình nhận diện",
    "step1Upload": "Tải ảnh",
    "step1UploadDesc": "Ảnh đã sẵn sàng",
    "step2Check": "Kiểm tra ảnh",
    "step2CheckDesc": "Đang kiểm tra...",
    "step3Analyze": "Phân tích AI",
    "step3AnalyzeDesc": "Đang phân tích...",
    "step4Predict": "Dự đoán",
    "step4PredictDesc": "Đang dự đoán...",
    "step5Done": "Hoàn tất",
    "step5DoneDesc": "Sắp xong...",
    "currentPlanTitle": "Gói hiện tại",
    "maxFileSize": "Dung lượng tối đa",
    "expiryDate": "Hết hạn",
    "viewPlanDetail": "Xem chi tiết gói",
    "noExpiry": "Không giới hạn",
    "validImageTitle": "Yêu cầu ảnh hợp lệ",
    "req1ValidDesc": "Chó xuất hiện rõ trong ảnh",
    "req2ValidDesc": "Không bị mờ hoặc quá tối",
    "req3ValidDesc": "Không bị che mặt/thân quá nhiều",
    "req4ValidDesc": "Ưu tiên ảnh một con chó",
    "req5ValidDesc": "Định dạng JPG, JPEG, PNG",
    "req6InvalidDesc": "Không chụp màn hình, ảnh có watermark",
    "recentIdentTitle": "Nhận diện gần đây",
    "dailyPetTipTitle": "Góc kiến thức & Mẹo nhỏ",
    "viewAllBtn": "Xem tất cả",
    "noRecentData": "Chưa có dữ liệu nhận diện.",
    "featureHighQualityExport": "Xuất kết quả chất lượng cao",
    "analyzeError": "Đã xảy ra lỗi khi phân tích ảnh",
    "connectError": "Đã xảy ra lỗi kết nối",
    ...
    "confirmRejectText": "Bạn có chắc chắn muốn từ chối đơn hàng {orderId} của {user}?",
    ...
    "sysLabelSiteDescVi": "Mô tả ngắn website (Tiếng Việt)",
    "sysLabelSiteDescEn": "Mô tả ngắn website (Tiếng Anh)",
    ...
    "sysLabelVietQrInstructionsVi": "Hướng dẫn thanh toán (Tiếng Việt)",
    "sysLabelVietQrInstructionsEn": "Hướng dẫn thanh toán (Tiếng Anh)",
    ...
    "expirationLabel": "Hạn gói:",
    "imageCol": "Ảnh",
    "predictionsRemaining": "Lượt nhận diện còn lại",
    "recentPredictionsDesc": "Danh sách ảnh chó vừa nhận diện trong hệ thống",
    "timeCol": "Thời gian",
    "unlimited": "Vô hạn",
    ...
    "speciesDog": "Chó",
    "exportModalTitle": "Xuất lịch sử nhận diện",
    "exportScopeLabel": "Phạm vi dữ liệu",
    "exportScopeAll": "Toàn bộ lịch sử",
    "exportScopeFiltered": "Theo bộ lọc hiện tại",
    "exportFormatLabel": "Định dạng xuất tệp",
    "exportFormatExcel": "Microsoft Excel (.xlsx)",
    "exportFormatCSV": "File CSV (.csv)",
    "exportBtn": "Tải file về",
    "toastExportStart": "Hệ thống đang chuẩn bị tệp tin...",
    "toastExportSuccess": "Xuất dữ liệu thành công!",
    "toastExportError": "Gặp sự cố khi xuất dữ liệu.",
    "noDataToExport": "Không tìm thấy dữ liệu để xuất.",
    "exportFormatPDF": "Báo cáo PDF (.pdf)",
    "printReportTitle": "BÁO CÁO KẾT QUẢ NHẬN DIỆN THÚ CƯNG",
    "printReportSubtitle": "Hệ thống nhận diện giống chó thông minh PetAI",
    "printDateLabel": "Ngày lập báo cáo",
    "printUserLabel": "Người lập báo cáo",
    "printPlanLabel": "Gói thành viên",
    "printStatsSummary": "Tóm tắt thống kê",
    "printDetailsTitle": "Danh sách chi tiết các ca nhận diện"
  ,
    ...
    "contactEmailFooter": "Email",
    "contactPhone": "Số điện thoại",
    "contactPhoneFooter": "Điện thoại",
    "footerPayment": "THANH TOÁN",
    "fullnameUsername": "Họ tên / Tên đăng nhập",
    "historyScan": "Lịch sử nhận dạng",
    "memoUpper": "NỘI DUNG CHUYỂN KHOẢN",
    "methodBank": "Chuyển khoản ngân hàng",
    "methodQR": "Quét mã QR",
    "noMatchingUsers": "Không tìm thấy người dùng",
    "orderCodeUpper": "MÃ ĐƠN HÀNG",
    "password": "Mật khẩu",
    ...
    "sysConfigDesc": "Cấu hình các thông số hệ thống",
    "sysConfigPageTitle": "Cấu hình hệ thống | PetAI",
    "sysConfigTitle": "Cấu hình hệ thống",
    "sysDescContact": "Cập nhật thông tin liên hệ.",
    "sysDescDeletion": "Cấu hình chính sách xóa dữ liệu.",
    "sysDescPayment": "Cấu hình chính sách thanh toán.",
    "sysDescPrivacy": "Cấu hình chính sách bảo mật.",
    "sysDescSupport": "Cấu hình trang hỗ trợ.",
    "sysDescTerms": "Cấu hình điều khoản dịch vụ.",
    "sysDescUserGuide": "Cập nhật hướng dẫn sử dụng.",
    "sysDescHome": "Biên soạn nội dung hiển thị cho trang chủ chính thức của hệ thống.",
    "sysEditPage": "Chỉnh sửa trang",
    "sysEmailsUnit": "email",
    "sysLegalDesc": "Cấu hình nội dung các trang pháp lý.",
    "sysLegalOptContact": "Liên hệ",
    "sysLegalOptDeletion": "Xóa dữ liệu",
    "sysLegalOptPayment": "Chính sách thanh toán",
    "sysLegalOptPrivacy": "Chính sách bảo mật",
    "sysLegalOptSupport": "Hỗ trợ",
    "sysLegalOptTerms": "Điều khoản dịch vụ",
    "sysLegalOptUserGuide": "Hướng dẫn sử dụng",
    "sysLegalOptHome": "Trang chủ",
    "sysLogoUploadNew": "Tải logo mới",
    "sysMethodsUnit": "phương thức",
    "sysPlanBasic": "Cơ bản",
    "sysPlanDurationDays": "Số ngày sử dụng",
    "sysPlanEntScanNote": "Ghi chú gói doanh nghiệp",
    "sysPlanEnterprise": "Doanh nghiệp",
    "sysPlanPriceVnd": "Giá (VND)",
    "sysPlanPro": "Chuyên nghiệp",
    "sysPlanScanLimit": "Giới hạn quét",
    "sysPlansDesc": "Cấu hình các gói dịch vụ.",
    "sysPlansTitle": "Gói dịch vụ",
    "sysPlansUnit": "gói",
    "sysViewPage": "Xem trang",
    "time30Days": "30 ngày",
    "time7Days": "7 ngày",
    "timeConfirmedLabel": "Đã xác nhận:",
    "timeCreatedLabel": "Đã tạo:",
    "timeToday": "Hôm nay",
    "timeUpper": "THỜI GIAN",
    ...
    "timeUpper": "THỜI GIAN",
    "transactionSuccess": "Giao dịch thành công",
    "predictResultPageTitle": "Kết quả - PetAI",
    "predResultTitle": "Kết quả nhận diện giống chó",
    "predResultDesc": "Hệ thống AI đã hoàn tất phân tích hình ảnh và dự đoán giống chó với độ chính xác cao.",
    "backToDashboard": "Về bảng điều khiển",
    "analyzeAnotherImg": "Phân tích ảnh khác",
    "visualAIInsights": "Visual AI Insights",
    "mainObjectAnalysis": "Ảnh đã phân tích (Bounding Box)",
    "analyzingText": "Đang phân tích",
    "mixLai": "Mix Lai",
    "bestPrediction": "Giống dự đoán tốt nhất",
    "confidence": "Độ tin cậy tổng thể",
    "hybridRatioTitle": "Phân tích tỷ lệ lai dự tính",
    "dominantGenExpected": "Gen trội dự kiến",
    "recessiveGenExpected": "Gen ẩn dự kiến",
    "similarityText": "Độ tương đồng",
    "similarityTop3": "Top 3 giống có độ tương đồng (Similarity)",
    "top3Probability": "Top 3 xác suất softmax",
    "visualProofTitle": "Grad-CAM động (Visual Proof)",
    "visualProofRefTitle": "Grad-CAM tham khảo (Visual Proof)",
    "visualProofDesc": "Bản đồ nhiệt AI tập trung khi nhận diện. Vùng AI chú ý: Đỏ (Cao), Vàng (Trung bình), Thấp (Xanh).",
    "visualProofRefDesc": "Bản đồ nhiệt AI tập trung khi nhận diện theo giống tham khảo.",
    "viewDetails": "Xem chi tiết",
    "aiHighlightArea": "Vùng nổi bật AI tập trung",
    "modelLogicAnalysis": "Phân tích Logic từ Model",
    "decisionHybridText": "Mức tin cậy đủ cho gợi ý ứng viên lai.",
    ...
    "heatmapResolution": "Độ phân giải bản đồ",
    "downloadGradcam": "Tải xuống ảnh Grad-CAM",
    "predictionType": "Loại dự đoán",
    "pureBreedLabel": "Chó thuần chủng (Pure)",
    "hybridBreedLabel": "Chó lai (Mix)",
    "analysisTime": "Thời gian phân tích",
    "analysisImage": "Ảnh phân tích",
    "validImageBadge": "Ảnh hợp lệ",
    "invalidImageBadge": "Ảnh không hợp lệ",
    "reAnalyzeBtn": "Phân tích lại ảnh",
    "saveHistoryBtn": "Lưu kết quả",
    "downloadReportBtn": "Tải báo cáo",
    "shareResultBtn": "Chia sẻ kết quả",
    "modelStatusLabel": "Trạng thái model",
    "modelStatusValue": "Tốt - Ổn định",
    "avgSystemConfLabel": "Độ tin cậy trung bình hệ thống",
    "changeImageBtn": "Đổi ảnh",
    "deleteImageBtn": "Xóa ảnh",
    "recentHistoryLabel": "Lịch sử gần đây",
    "viewAllHistoryBtn": "Xem tất cả lịch sử",
    "cardBestBreed": "Giống dự đoán",
    "cardPredType": "Loại dự đoán",
    "cardAnalysisTime": "Thời gian phân tích",
    "cardImageInfo": "Ảnh phân tích",
    "hybridCandidate": "Ứng viên chó lai",
    "lowConfidenceResult": "Độ tin cậy thấp",
    "pureBreedCandidate": "Ứng viên thuần chủng",
    "hybridLabel": "Lai",
    "pureLabel": "Thuần chủng",
    "validImage": "Hợp lệ",
    "notAvailable": "--",
    ...
    "shareResultDesc": "Chia sẻ kết quả này với bạn bè",
  ...
  "en": {
    ...
    "exportModalTitle": "Export Identification History",
    "exportScopeLabel": "Data Scope",
    "exportScopeAll": "All history data",
    "exportScopeFiltered": "According to current filters",
    "exportFormatLabel": "Select file format",
    "exportFormatExcel": "Microsoft Excel (.xlsx)",
    "exportFormatCSV": "CSV File (.csv)",
    "exportBtn": "Download File",
    "toastExportStart": "Preparing your export file...",
    "toastExportSuccess": "Data exported successfully!",
    "toastExportError": "Error preparing export file.",
    "noDataToExport": "No history data found to export.",
    "exportFormatPDF": "PDF Report (.pdf)",
    "printReportTitle": "PET IDENTIFICATION REPORT",
    "printReportSubtitle": "PetAI Intelligent Pet Identification System",
    "printDateLabel": "Report Date",
    "printUserLabel": "Generated By",
    "printPlanLabel": "Membership Plan",
    "printStatsSummary": "Statistical Summary",
    "printDetailsTitle": "Detailed Identification List",
    ...
    "approveBankTransfersDesc": "Display orders that users have reported as paid for admin approval.",
    "exportConfirmationsTitle": "Export Bank Transfers",
    "exportConfirmationsScope": "Export Scope",
    "exportConfirmationsScopeAll": "All Transactions",
    "exportConfirmationsScopeFiltered": "Current Filters",
    "exportConfirmationsFormat": "Download Format",
    "exportConfirmationsBtnDownload": "Download",
    "toastExportConfirmationsStart": "Preparing report file...",
    ...
    "validImageBadge": "Valid Image",
    "invalidImageBadge": "Invalid Image",
    "deleteImageBtn": "Delete",
    "securityNote": "Your data is completely secured",
    "processingTitle": "Processing Pipeline",
    "step1Upload": "Upload",
    "step1UploadDesc": "Image ready",
    "step2Check": "Verify Image",
    "step2CheckDesc": "Verifying...",
    "step3Analyze": "AI Analysis",
    "step3AnalyzeDesc": "Analyzing...",
    "step4Predict": "Prediction",
    "step4PredictDesc": "Predicting...",
    "step5Done": "Complete",
    "step5DoneDesc": "Almost done...",
    "currentPlanTitle": "Current Plan",
    "maxFileSize": "Max File Size",
    "expiryDate": "Expires",
    "viewPlanDetail": "View Plan Details",
    "noExpiry": "Unlimited",
    "validImageTitle": "Valid Image Requirements",
    "req1ValidDesc": "Dog clearly visible in image",
    "req2ValidDesc": "Not blurry or too dark",
    "req3ValidDesc": "Face/body not excessively covered",
    "req4ValidDesc": "Prefer single dog image",
    "req5ValidDesc": "Format JPG, JPEG, PNG",
    "req6InvalidDesc": "No screenshots or watermarked images",
    "recentIdentTitle": "Recent Identifications",
    "dailyPetTipTitle": "Pet Knowledge & Tips",
    "viewAllBtn": "View All",
    "noRecentData": "No identification data yet.",
    "featureHighQualityExport": "Export high-quality results",
    "analyzeError": "An error occurred while analyzing the image",
    ...
    "confirmPaymentText": "Confirm payment received for order {orderId} ({user} - {plan})?",
    ...
    "confirmRejectText": "Are you sure you want to reject order {orderId} of {user}?",
    ...
    "sysLabelSiteDescVi": "Site Short Description (Vietnamese)",
    "sysLabelSiteDescEn": "Site Short Description (English)",
    ...
    "sysLabelVietQrInstructionsVi": "Payment Instructions (Vietnamese)",
    "sysLabelVietQrInstructionsEn": "Payment Instructions (English)",
    ...
    "expirationLabel": "Plan expiry:",
    "imageCol": "Image",
    "predictionsRemaining": "Scans remaining",
    "recentPredictionsDesc": "List of recently identified dog images in the system",
    "timeCol": "Time",
    "unlimited": "Unlimited",
  ...
  ,
      ...
      "sysConfigDesc": "System configuration parameters",
      "sysConfigPageTitle": "System Config | PetAI",
      "sysConfigTitle": "System Config",
      "sysDescContact": "Update contact information.",
      "sysDescDeletion": "Configure data deletion policy.",
      "sysDescPayment": "Configure payment policy.",
      "sysDescPrivacy": "Configure privacy policy.",
      "sysDescSupport": "Configure support page.",
      "sysDescTerms": "Configure terms of service.",
      "sysDescUserGuide": "Update user guide.",
      "sysDescHome": "Edit the content displayed on the official homepage of the system.",
      "sysEditPage": "Edit Page",
      "sysEmailsUnit": "emails",
      "sysLegalDesc": "Configure legal page content.",
      "sysLegalOptContact": "Contact",
      "sysLegalOptDeletion": "Data Deletion",
      "sysLegalOptPayment": "Payment Policy",
      "sysLegalOptPrivacy": "Privacy Policy",
      "sysLegalOptSupport": "Support",
      "sysLegalOptTerms": "Terms of Service",
      "sysLegalOptUserGuide": "User Guide",
      "sysLegalOptHome": "Homepage",
      "sysLogoUploadNew": "Upload New Logo",
      "sysMethodsUnit": "methods",
      "sysPlanBasic": "Basic",
      "sysPlanDurationDays": "Duration (Days)",
      "sysPlanEntScanNote": "Enterprise Scan Note",
      "sysPlanEnterprise": "Enterprise",
      "sysPlanPriceVnd": "Price (VND)",
      "sysPlanPro": "Pro",
      "sysPlanScanLimit": "Scan Limit",
      "sysPlansDesc": "Configure service plans.",
      "sysPlansTitle": "Service Plans",
      "sysPlansUnit": "plans",
      "sysViewPage": "View Page",
      "time30Days": "30 days",
      "time7Days": "7 days",
      "timeConfirmedLabel": "Confirmed:",
      ...
      "timeUpper": "TIME",
      "transactionSuccess": "Transaction Success",
      "predictResultPageTitle": "Result - PetAI",
      "predResultTitle": "Dog Breed Identification Results",
      "predResultDesc": "AI system has completed image analysis and predicted dog breed with high accuracy.",
      "backToDashboard": "Back to dashboard",
      "analyzeAnotherImg": "Analyze another image",
      "visualAIInsights": "Visual AI Insights",
      "mainObjectAnalysis": "Analyzed Image (Bounding Box)",
      "analyzingText": "Analyzing",
      "mixLai": "Mix Breed",
      "bestPrediction": "Best Prediction",
      ...
      "recessiveGenExpected": "Expected recessive gene",
      "similarityText": "Similarity",
      "similarityTop3": "Top 3 Morphological Similarity (Similarity)",
      "top3Probability": "Top 3 Softmax Probability",
      "visualProofTitle": "Dynamic Grad-CAM (Visual Proof)",
      "visualProofRefTitle": "Reference Grad-CAM (Visual Proof)",
      "visualProofDesc": "AI attention heatmap. Attention regions: Red (High), Yellow (Medium), Blue (Low).",
      "visualProofRefDesc": "AI attention heatmap based on reference breed.",
      "viewDetails": "View details",
      "aiHighlightArea": "Highlighted region AI focused on",
      "modelLogicAnalysis": "Logic Analysis from Model",
      "decisionHybridText": "Confidence level sufficient for hybrid suggestion.",
      ...
      "shareResultDesc": "Share this result with your friends",
      "analyzeAnotherTitle": "Analyze Another Image",
      "analyzeAnotherDesc": "Choose another photo to analyze",
      "recentHistory": "Recent History",
      "viewAll": "View All",
      "noRecentHistory": "No identification history yet",
      "card2Description": "Based on morphological features",
      "mixConclusionLabel": "Conclusion",
      "mixConclusionDesc": "Prediction based on morphological features, not genetic testing.",
      "viewModelInfo": "Model Information",
      ...
      "btnReanalyze": "Re-analyze Image",
      "btnChangeImage": "Change Image",
      "btnDeleteImage": "Delete Image",
      "gradcamLegend": "AI heatmap showing attention during detection. AI focus levels: <span class=\"text-red-500 font-bold\">High (Red)</span>, <span class=\"text-yellow-500 font-bold\">Medium (Yellow)</span>, <span class=\"text-blue-500 font-bold\">Low (Blue)</span>",
      "gradcamModalDesc": "The Grad-CAM heatmap visualizes the key regions on the pet's body that the AI model focused on most to make the breed prediction decision.",
      "mixConclusionPrefix": "Image has hybrid characteristics between",
