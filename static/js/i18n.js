...
(function () {
  ...
  var TRANSLATIONS = {
    vi: {
      ...
      sysLegalOptPrivacy: "Chính sách quyền riêng tư (Privacy Policy)",
      sysLegalOptTerms: "Điều khoản sử dụng (Terms of Service)",
      sysLegalOptPayment: "Chính sách thanh toán (Payment Policy)",
      sysLegalOptDeletion: "Chính sách xóa dữ liệu (Data Deletion Policy)",
      sysLegalOptSupport: "Hỗ trợ (Support Page)",
      sysLegalOptContact: "Liên hệ (Contact Page)",
      sysLegalOptUserGuide: "Hướng dẫn sử dụng (User Guide)",
