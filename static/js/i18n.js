...
(function () {
  ...
  var TRANSLATIONS = {
    vi: {
      ...
      sysLegalOptPrivacy: "Chính sách bảo mật (Privacy Policy)",
      sysLegalOptTerms: "Điều khoản dịch vụ (Terms of Service)",
      sysLegalOptPayment: "Chính sách thanh toán (Payment Policy)",
      sysLegalOptDeletion: "Yêu cầu xóa dữ liệu (Data Deletion Policy)",
      sysLegalOptSupport: "Trang Hỗ trợ & Hướng dẫn (Support Page)",
    ...
    en: {
      ...
      sysLegalOptSupport: "Support Page & Guides",
