...
15. [Lưu ý quan trọng khi sử dụng](#15-lưu-ý-quan-trọng-khi-sử-dụng)
...
1. **Phát hiện vùng đối tượng (YOLOv8)**: Hệ thống sử dụng mô hình phát hiện đối tượng YOLOv8s để tìm kiếm chú chó trong hình ảnh với ngưỡng tin cậy tối thiểu.
...
## 15. Lưu ý quan trọng khi sử dụng
